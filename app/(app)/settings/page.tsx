...
export default async function SettingsPage({
  ...
  return (
    <>
      ...
      <p className="page-sub">Your account, security, appearance, and data.</p>

      {error && <div className="form-error">{error}</div>}
      {saved && SAVED_MESSAGES[saved] && (
        <p className="form-saved" style={{ marginBottom: "1.25rem" }}>{SAVED_MESSAGES[saved]}</p>
      )}
      ...
      <div className="card">
        ...
        <p style={{ fontSize: "0.95rem", color: "var(--muted)", marginBottom: "0.9rem", maxWidth: "44rem" }}>
          ...
          any time from your <Link href="/profile">profile</Link>.
        </p>
      ...
      <div className="card" style={{ borderColor: "var(--danger-border)" }}>
        <h3 style={{ color: "var(--danger-ink)" }}>Danger zone</h3>
